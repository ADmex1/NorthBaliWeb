        ...
        <div className="max-w-screen-xl mx-auto bg-white shadow-xl min-h-screen py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md mx-auto bg-gray-50 rounded-lg p-8">
                <div className="text-center">
                    <User className="mx-auto h-16 w-16 text-cyan-600" />
                    <h2 className="mt-4 text-2xl font-bold text-gray-900">Profil Pengguna</h2>
                </div>
                ...
                <button onClick={handleLogout} className="mt-8 group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500">
